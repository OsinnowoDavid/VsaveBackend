...
export class EmailService {
    ...
    constructor(config?: Partial<EmailConfig>) {
        ...
        if (
            ...
            throw new Error(
                "SMTP configuration missing. Check your .env file.",
            );
        }
        ...
        console.log(
            `- Auth User: ${emailConfig.auth.user ? "✅ Set" : "❌ Missing"}`,
        );
        ...
        try {
            ...
            if (error instanceof Error) {
                if (error.message.includes("wrong version number")) {
                    ...
                    console.error(
                        "3. Your API key/SMTP credentials are active",
                    );
                    ...
                    console.error(
                        "3. Your firewall allows outbound SMTP connections",
                    );
                }
            }
    ...
    async sendTemplateEmail(
        ...
        return this.sendEmail({
            ...
            text:
                templateData.text || templateData.html.replace(/<[^>]*>/g, ""),
            ...options,
        });
    }
